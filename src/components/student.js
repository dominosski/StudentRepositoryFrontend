...
export default function Student() {
    ...
    const handleClick = async (e) => {
        ...
        await fetch("https://student-repository-backend.azurewebsites.net/api/student", {
            method: "POST",
    ...
    const HandleSearchClick = async (e) => {
        ...
        const response = await fetch("https://student-repository-backend.azurewebsites.net/api/student", {
            method: "GET"
        })
    ...
    const HandleDeleteClick = async (e, id) => {
        ...
        await fetch(`https://student-repository-backend.azurewebsites.net/api/student/${id}`, {
            method: "DELETE"
        }).then(() => {
